...
export const AddBlog = ({ onClose }) => {
  const { blogPosts, isLoading, setIsLoading, showModal, setShowModal } = useContext(context)
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { author, title, description, imageUrl } = blogData;
    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center px-4">
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <Typography
            variant="h4"
            className="text-2xl font-semibold border-b-4 border-[#616161] text-[blue-gray] font-black"
          >
            Upload Blog
          </Typography>
          <Button
